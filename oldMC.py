...
class MC(Greed_Simulator):
    ...
    def __init__(self, height=15, width=55, model = None, epsilon = 0.1, gamma = .1):
    ...
    def train(self, episodes, save_name = None, verbose = True):
        ...
        for i in range(episodes):
            ...
            for j in range(start, end, step):
                # print(self.sar[i][3])
                G = G*self.GAMMA + self.sar[j][3] # should be the reward of the previous time step
